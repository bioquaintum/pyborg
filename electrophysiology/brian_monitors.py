# pyborg/electrophysiology/brian_monitors.py
...
StateMonitor, and PopulationRateMonitor for pyborg simulations.
"""
...
def setup_spike_monitor(source, record=True, name=None, **kwargs):
    ...
    **kwargs :
    ...
    >>> from pyborg.electrophysiology.brian_monitors import setup_spike_monitor
...
def setup_state_monitor(source, variables, record=True, dt=None, name=None, **kwargs):
    ...
    **kwargs :
    ...
    >>> from pyborg.electrophysiology.brian_monitors import setup_state_monitor
...
def setup_population_rate_monitor(source, name=None, **kwargs):
    ...
    **kwargs :
    ...
    >>> from pyborg.electrophysiology.brian_monitors import setup_population_rate_monitor
