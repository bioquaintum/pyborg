# pyborg/organoid/organoid.py

"""
Defines the main Organoid class for pyborg simulations.
...
import brian2 as b2
import numpy as np
# Importar modelos e funções espaciais dos outros módulos do pyborg
...
class Organoid:
    ...
    ----------
    name : str, optional
        A descriptive name for the organoid instance (default: "pyborg_organoid").
    ...
    def __init__(self, name="pyborg_organoid", default_brian2_prefs=None):
        """
    ...
    def add_neurons(self, name, num_neurons, model_name, model_params=None,
        ...
        model_name : str
            The name of the neuron model function to use from `pyborg.core.neuron_models`
        ...
        spatial_distribution_func : str, optional
            ...
            `pyborg.organoid.spatial` (e.g., "random_positions_in_cube").
        ...
        **kwargs :
        ...
        try:
            ...
            raise ValueError(f"Neuron model function '{model_name}' not found in pyborg.core.neuron_models.")
        ...
        if positions is not None:
            ...
            try:
                ...
                raise ValueError(f"Spatial distribution function '{spatial_distribution_func}' not found in pyborg.organoid.spatial.")
    ...
    def add_synapses(self, name, pre_group_name, post_group_name,
        ...
        model_name : str
            Name of the synapse model function from `pyborg.core.synapse_models`.
        model_params : dict, optional
        ...
        **kwargs :
        ...
        try:
            ...
            raise ValueError(f"Synapse model function '{model_name}' not found in pyborg.core.synapse_models.")
